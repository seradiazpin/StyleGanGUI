...
if 1:
    ...
    # Dataset.
    desc += '-poke';     dataset = EasyDict(tfrecord_dir='poke', resolution=64); train.mirror_augment = False
    ...
    #python dataset_tool.py create_from_images datasets/poke ../StyleGAN2-Tensorflow-2.0/data/poke
    # Table 1.
